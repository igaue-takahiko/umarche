                    ...
                    <section class="relative text-gray-600 body-font">
                        <div class="container px-5 x-auto p">
                            <div class="flex flex-col w-full mb-12 text-center">
                                <h1 class="mb-4 text-2xl font-medium text-gray-900 sm:text-3xl title-font">オーナー情報編集</h1>
                            </div>
                                    ...
                                    <div class="m-2">
                                        <div class="w-1/2 p-2 mx-auto">
                                            <div class="relative">
                                                ...
                                                <input type="text" id="name" name="name" value="{{ $owner->name }}" required class="w-full px-3 py-1 text-base leading-8 text-gray-700 transition-colors duration-200 ease-in-out bg-gray-100 bg-opacity-50 border border-gray-300 rounded outline-none focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-200">
                                            </div>
                                        </div>
                                        <div class="w-1/2 p-2 mx-auto">
                                            <div class="relative">
                                        ...
                                        <div class="flex justify-around w-full p-2 mt-4">
                                            <button type="button" class="px-8 py-2 text-lg text-white bg-gray-400 border-0 rounded focus:outline-none hover:bg-gray-500" onclick="location.href= '{{ route('admin.owners.index') }}'">戻る</button>
